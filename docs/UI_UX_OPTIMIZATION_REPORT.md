...
Il documento è un progetto di aggiornamento, supportato dall'analisi del codice e dell'interfaccia installata. Le funzionalità descritte come proposte non sono ancora implementate. Questa attività non ha avviato assessment, modificato configurazioni o distribuito modifiche alla UI.
